...
namespace TaskManager.Web.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public AccountController(IRepository<TaskManager.Core.Storage.Entities.User> userRepository, Lazy<UserManager<ApplicationUser>> userManager)
        {
        ...
        public AccountController(ApplicationUserManager userManager,
            ...
            IRepository<TaskManager.Core.Storage.Entities.User> userRepository)
        {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var userEntity = _userRepository.GetOrCreate(null);
            userEntity.Account = user;
